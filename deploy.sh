...
sudo docker tag $DOCKER_IMAGE $ACCOUNT_ID.dkr.ecr.us-west-2.amazonaws.com/fargate-api-test:latest
sudo docker push $ACCOUNT_ID.dkr.ecr.us-west-2.amazonaws.com/fargate-api-test:latest
